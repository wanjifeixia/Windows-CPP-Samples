...
BOOL WINAPI NewMagImageScalingCallback(HWND hwnd, void* srcdata, MAGIMAGEHEADER srcheader, void* destdata, MAGIMAGEHEADER destheader, RECT unclipped, RECT clipped, HRGN dirty)
{
	DrawWatermark(destheader.width, destheader.height, destheader.stride, destdata);
	return TRUE;
}
...
// 	if (MagGetImageScalingCallback(hMag) == NULL)
// 	{
// 		MagSetImageScalingCallback(hMag, NewMagImageScalingCallback);
// 	}
